                                                                ...
                                                                <div class="m-dropdown__body">
                                                                    <div class="m-dropdown__content">
                                                                        <ul class="m-nav">
                                                                            ...
                                                                            <li class="m-nav__item">
                                                                                <a href="<?php echo site_url('user/registrasi_user') ?>" class="m-nav__link">
...
$('.dataTables_filter input').addClass('form-control');
    ...
    function edit_user(kode)
    {
        $('#fuser')[0].reset(); // reset form on modals
        $('.form-group').removeClass('has-error'); // clear error class
        $('.help-block').empty(); // clear error string

        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('user/ajax_edit/')?>/" + kode,
            type: "GET",
            dataType: "JSON",
...
function delete_user(kode){
  swal({
      ...
      if (isConfirm) {
          swal("Berhasil Dihapus!", "Data user yang anda pilih sudah terhapus", "success");

          $.ajax({
              url : "<?php echo site_url('user/hapus_user')?>/"+kode,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
